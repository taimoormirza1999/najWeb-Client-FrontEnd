      ...
      <div className="bg-teal-blue rounded-xl p-6 text-white lg:p-8 xl:p-12">
        <div className="flex flex-col justify-between gap-8 md:flex-row">
          <div className="basis-2/3 lg:basis-3/4 xl:pr-10">
            <h3 className="py-4 pt-0 text-2xl font-semibold md:text-3xl lg:text-4xl xl:text-5xl">
              <FormattedMessage id="general.apply_for_account" />
            </h3>
            <p className="py-4 text-xl leading-normal lg:text-2xl xl:text-4xl xl:leading-[3rem] 2xl:leading-[4rem]">
          ...
          <div className="bg-light-grey flex basis-1/3 items-center justify-center rounded-2xl lg:basis-1/4">
