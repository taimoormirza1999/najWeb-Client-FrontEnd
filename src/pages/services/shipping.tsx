    ...
    <div className="container mx-auto">
      <div className="border-dark-blue flex flex-col rounded-lg border p-4 lg:p-8 xl:flex-row">
        <div className="text-dark-blue basis-3/5 p-2 xl:p-8">
          ...
          <p className="py-4 text-lg leading-normal md:text-xl lg:py-8 lg:text-2xl lg:leading-[2.8rem] xl:pr-10">
            ...
            adopted the principle of competitiveness and leadership in the field
            of the car logistic of all kinds for most of the Gulf Cooperation
            Countries in addition to the import and customs clearance services
            for cars coming from abroad to the United Arab Emirates by ensuring
            the highest levels of quality and competitive prices providing all
          ...
          <Link href="#receiveService">
            <a className="text-azure-blue block py-3 text-lg italic hover:border-0 md:text-xl lg:text-2xl">
              Receive service...
            </a>
          </Link>
        </div>
        <div className="relative basis-2/5">
          ...
          />
          <Link href="#receiveService">
            <a className="bg-azure-blue absolute inset-x-0 bottom-[10%] m-auto max-w-max rounded-lg py-3 px-6 text-lg font-medium text-white hover:border-0 md:text-2xl lg:text-3xl">
              Receive Service
            </a>
          </Link>
        </div>
      ...
      <div className="px-0 py-4 md:py-8 xl:px-16">
        ...
        <div className="mb-4 flex gap-16 lg:mb-8">
          ...
          <p className="border-teal-blue text-teal-blue flex w-full items-center rounded-2xl border-[3px] p-4 text-lg lg:text-[1.3rem]">
        ...
        <div className="mb-4 flex gap-16 lg:mb-8">
          ...
          <p className="border-teal-blue text-teal-blue flex items-center rounded-2xl border-[3px] p-4 text-lg lg:text-[1.3rem]">
      ...
      <div className="mb-16 py-8" id="receiveService">
